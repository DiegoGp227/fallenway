    ...
    <form onSubmit={handleSubmit(login)} className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col">
        <input
          ...
          disabled={loading}
        />
        <label htmlFor="email" className="order-1 text-fg-muted peer-focus:text-accent transition-colors duration-300">
          Email
        </label>
      </div>
      {errors.email && (
      ...
      <div className="flex flex-col">
        <input
          ...
          disabled={loading}
        />
        <label htmlFor="password" className="order-1 text-fg-muted peer-focus:text-accent transition-colors duration-300">
          Password
        </label>
      </div>
      {errors.password && (
      ...
      <button
        ...
        disabled={loading}
        className="flex items-center justify-center gap-2 border-2 border-accent px-1 py-2 bg-base hover:bg-gray-900 transition-all duration-500 rounded font-semibold text-white"
      >
        <svg
      ...
      <button
        type="submit"
        className="flex items-center justify-center gap-2 border-2 border-accent px-1 py-2 bg-accent hover:bg-accent transition-all duration-500 text-white"
        disabled={loading}
      >
        {loading ? (
          "Loading..."
